...
public class GameLogic implements Runnable{
    ...
    public void addSingleEnemy(int location ,int thisType) {
        	Enemy newEnemy = new Enemy(defaultEnemySpawnpoint, location, defaultEnemySpeed, thisType);
        ...
        if (enemyTimer >= 400){
            ...
            if (location<= prevEnemyLocation-135 || location>=prevEnemyLocation+135){
            	...
            	SwingUtilities.invokeLater(() -> {
            		type = type%3;
            		if (SettingPanel.OctalIsSelect && type == 0) {
                		addSingleEnemy(location, type);
