...
public class Enemy extends JPanel {
    ...
    public int numberRand = rand.nextInt(1,255);
    public float x;
    public float y;
    public float speed;
    public int type;
    ...
    public void setDefaultBorder() {
        setBorder(new javax.swing.border.MatteBorder(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("res/images/greenBorder.png"))))); // NOI18N
    }
